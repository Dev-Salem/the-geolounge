...
class Post2 extends Equatable {
  ...
  factory Post2.fromMap(Map<String, dynamic> map) {
    return Post2(
      id: map['id'] as String,
      userId: map['user_id'] as String,
      creationDate: DateTime.parse(map['created_at'] as String),
      ...
      country: map['country'] as String,
      city: map['city'] as String,
      upvotes: (map['upvotes'] as List<dynamic>).length,
      downvotes: (map['downvotes'] as List<dynamic>).length,
    );
  }
